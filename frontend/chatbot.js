/**
 * Pneuzinho Chatbot - Friendly virtual assistant for Central Autocar.
 * Optimized for older users: large fonts, clickable steps, clear layout, no text input required.
 */

(function () {
  const WHATSAPP_NUMBER = '5573988879617';

  // State Definitions & Copywriting Funnel
  const FUNNEL_STATES = {
    start: {
      message: 'Olá! Sou o <b>Pneuzinho</b>, o ajudante virtual da Central Autocar. 🛞<br><br>Como posso te ajudar hoje? Escolha uma das opções abaixo clicando nela:',
      options: [
    ...
    pneus_final_13_14: {
      ...
      whatsappText: 'Olá! Gostaria de consultar pneus Aro 13 ou Aro 14 na Central Autocar. Fui direcionado pelo assistente do site.'
    },
    pneus_final_15_16: {
      ...
      isFinal: true,
      buttonText: '🟢 Ver Ofertas no WhatsApp',
      whatsappText: 'Olá! Gostaria de consultar pneus Aro 15 ou Aro 16 na Central Autocar. Fui direcionado pelo assistente do site.'
    },
    pneus_final_17_18: {
      ...
      whatsappText: 'Olá! Gostaria de consultar pneus Aro 17 ou Aro 18 na Central Autocar. Fui direcionado pelo assistente do site.'
    },
    pneus_final_19: {
      ...
      whatsappText: 'Olá! Gostaria de consultar pneus Aro 19 ou maior na Central Autocar. Fui direcionado pelo assistente do site.'
    },
    pneus_final_ajuda: {
    ...
    servicos_suspensao: {
      ...
      whatsappText: 'Olá! Gostaria de solicitar um orçamento para revisão da suspensão e amortecedores do meu carro na Central Autocar. Fui direcionado pelo assistente do site.'
    },
    servicos_freios: {
      ...
      whatsappText: 'Olá! Gostaria de solicitar um orçamento para o serviço de freios (pastilha e disco) do meu carro na Central Autocar. Fui direcionado pelo assistente do site.'
    },
    servicos_revisao: {
      message: 'Fazer uma revisão de rotina é a melhor forma de economizar e rodar tranquilo. 🛣️<br><br>Clique abaixo para agendar sua revisão geral na Central Autocar.',
      isFinal: true,
    ...
    alinhamento_preventiva: {
      message: 'Parabéns pela prevenção! É recomendado alinhar a cada 10.000 km rodados. 🧭<br><br>Clique abaixo para agendar sua manutenção de rotina na Central Autocar.',
      isFinal: true,
    ...
    falar_atendente: {
      ...
      whatsappText: 'Olá! Gostaria de tirar algumas dúvidas e falar com um atendente da Central Autocar. Fui direcionado pelo assistente do site.'
    }
  };
  ...
  function showTypingIndicator() {
    ...
    indicator.innerHTML = `
      <img src="public/pneuzinho.jpg" alt="Pneuzinho" class="w-8 h-8 rounded-full object-cover mt-0.5 border border-brand-yellow shrink-0">
    ...
    setTimeout(() => {
      ...
      if (stateData.isFinal) {
        ...
        optionsContainer.innerHTML = `
          <a href="${waLink}" target="_blank" onclick="if(window.CA_Analytics)window.CA_Analytics.trackWhatsappClick('chatbot_${stateKey}')" class="w-[90%] text-center bg-brand-yellow text-zinc-950 font-black text-base py-4 px-6 rounded-2xl shadow-lg border border-brand-yellow/80 hover-glow-yellow transition-all duration-300 hover:scale-[1.03] active:scale-95 block flex items-center justify-center gap-2.5">
        ...
        stateData.options.forEach((opt) => {
          ...
          btn.className = 'w-[90%] text-left bg-white text-zinc-800 font-extrabold text-[15px] py-3.5 px-5 rounded-2xl shadow-sm border border-zinc-200 hover:border-amber-400 hover:text-amber-500 transition-all duration-300 hover:scale-[1.02] active:scale-95 cursor-pointer';
